...
icon = PhotoImage(file="image/task.png")
...
button=Button(frame,text="ADD",width=6,font="arial 20 bold",bg="#5a95ff",fg="#fff",bd=0,command=addTask)
button.place(x=300,y=0)

#listbox
frame1=Frame(root,bd=0,width=700,height=280,bg="#32405b")
